<?php  // $Id: lib.php,v 1.1.2.8 2011/06/23 19:35:00 agrabs Exp $
...
class feedback_item_multichoice extends feedback_item_base {
    ...
    function create_item() {
        ...
        $data = new stdClass();
        $data->itemvalues = optional_param('itemvalues', '', PARAM_NOTAGS);
        $data->subtype = optional_param('subtype', 'r', PARAM_ALPHA);
        $data->horizontal = optional_param('horizontal', 0, PARAM_INT);
        $item->presentation = $this->get_presentation($data);
        return $item;
    }
    ...
    function get_presentation($data) {
        ...
        if($data->horizontal AND $subtype != 'd') {
