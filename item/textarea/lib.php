<?php  // $Id: lib.php,v 1.6.2.8 2011/06/02 14:00:16 agrabs Exp $
...
class feedback_item_textarea extends feedback_item_base {
    ...
    function create_item() {
        ...
        $data = new stdClass();
        $data->itemwidth = optional_param('itemwidth', 5, PARAM_INT);
        $data->itemheight = optional_param('itemheight', 5, PARAM_INT);
