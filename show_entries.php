<?php // $Id: show_entries.php,v 1.6.2.8 2011/05/31 22:59:05 danmarsden Exp $
/**
* print the single entries
*
* @version $Id: show_entries.php,v 1.6.2.8 2011/05/31 22:59:05 danmarsden Exp $
...
*/
    ...
    if((data_submitted('nomatch')) AND !confirm_sesskey()) {
