<?php  // $Id: lib.php,v 1.6.2.7 2011/06/02 14:00:16 agrabs Exp $
...
class feedback_item_textfield extends feedback_item_base {
    ...
    function create_item() {
        ...
        $data = new stdClass();
        $data->itemsize = optional_param('itemsize', 5, PARAM_INT);
        $data->itemmaxlength = optional_param('itemmaxlength', 5, PARAM_INT);
