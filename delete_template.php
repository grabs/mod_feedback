<?php // $Id: delete_template.php,v 1.5.2.2 2011/05/31 22:59:05 danmarsden Exp $
/**
* deletes a template
*
* @version $Id: delete_template.php,v 1.5.2.2 2011/05/31 22:59:05 danmarsden Exp $
...
*/
    ...
    if(isset($formdata->confirmdelete) AND $formdata->confirmdelete == 1){
        feedback_delete_template((int)$formdata->deletetempl);
        redirect(htmlspecialchars('delete_template.php?id=' . $id));
    }
