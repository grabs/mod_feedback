<?php  // $Id: lib.php,v 1.7.2.7 2011/06/02 14:00:16 agrabs Exp $
...
class feedback_item_numeric extends feedback_item_base {
    ...
    function create_item() {
        ...
        $data = new stdClass();
        $data->numericrangefrom = optional_param('numericrangefrom', 0, PARAM_TEXT);
        $data->numericrangeto = optional_param('numericrangeto', 0, PARAM_TEXT);
