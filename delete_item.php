<?php // $Id: delete_item.php,v 1.3.2.3 2011/05/31 22:59:05 danmarsden Exp $
/**
* deletes an item of the feedback
*
* @version $Id: delete_item.php,v 1.3.2.3 2011/05/31 22:59:05 danmarsden Exp $
...
*/
    ...
    if(isset($formdata->confirmdelete) AND $formdata->confirmdelete == 1){
        feedback_delete_item((int)$formdata->deleteitem);
        redirect('edit.php?id=' . $id);
    }
