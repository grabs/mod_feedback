<?php // $Id: show_entries_anonym.php,v 1.5.2.4 2011/05/31 22:59:05 danmarsden Exp $
/**
* print the single-values of anonymous completeds
*
* @version $Id: show_entries_anonym.php,v 1.5.2.4 2011/05/31 22:59:05 danmarsden Exp $
...
<?php
    ...
    if(isset($formdata->showanonym) && $formdata->showanonym == FEEDBACK_ANONYMOUS_YES) {
        ...
        $feedbackcompleted = get_record('feedback_completed', 'id', (int)$formdata->completedid);
